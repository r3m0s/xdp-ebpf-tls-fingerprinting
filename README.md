...
The `str2ja3` file produces a 32-character JA3 jhash of the raw TLS handshake string using MD5.
The `str2ja4` file produces a JA4 fingerprint using SHA-256, but keeping the protocol prefix in plaintext.
